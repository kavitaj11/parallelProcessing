...
public class TestBase  {
    ...
    public String buildTag = "1.2";//System.getenv("BUILD_TAG");

    public String username = "keshav_kashyap";//System.getenv("SAUCE_USERNAME");

    public String accesskey = "f699992c-4d31-4b12-a10d-b7038da5a356";//System.getenv("SAUCE_ACCESS_KEY");
